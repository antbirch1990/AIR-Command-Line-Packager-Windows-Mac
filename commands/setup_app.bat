set air_sdk=../../AIR_SDK/AIR16.0/bin/adt

::: iOS :::
set ios_adhoc_certificate=certificates/AdHoc_Certificate.p12
set ios_development_certificate=certificates/Development_Certificate.p12
set ios_distribution_certificate=certificates/Distribution_Certificate.p12
set ios_adhoc_password=password
set ios_development_password=password
set ios_distribution_password=password
...
set ios_bundle_id=com.website.appName
